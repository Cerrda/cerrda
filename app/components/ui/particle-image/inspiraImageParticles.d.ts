...
export declare class InspiraImageParticle implements InspiraImageParticleProps, EventHandlers {
  ...
  private _initParticlePosition(origin: unknown, particle: unknown): void
  private _initParticleDirection(particle: unknown): void
  private _fadeOriginPosition(origin: unknown): void
  private _fadeOriginDirection(particle: unknown): void
