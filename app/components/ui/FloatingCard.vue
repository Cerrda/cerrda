  ...
  >
    <div
      ...
      :style="{
        ...
        boxShadow: `oklch(0.45 0.1 350 / 0.02) 0px 520px 146px 0px, oklch(0.45 0.1 350 / 0.06) 0px 333px 133px 0px, oklch(0.4 0.1 350 / 0.2) 0px 83px 83px 0px, oklch(0.4 0.08 350 / 0.22) 0px 21px 46px 0px`,
      }"
